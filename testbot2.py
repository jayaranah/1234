                ...
                if Setmain["RAautojoin"] == True:
                    if Setmain["RAbatas"]["on"] == True:
                        ...
                        if len(G.members) > Setmain["RAbatas"]["members"]:
                            nadya.acceptGroupInvitation(op.param1)
                            ra = nadya.getGroup(op.param1)
                            nadya.sendText(op.param1,"Maaf jumlah member\n " + str(ra.name) + " lebih dari " + str(Setmain["RAbatas"]["members"]))
                            nadya.leaveGroup(op.param1)
                        else:
                            nadya.acceptGroupInvitation(op.param1)
                            ra = nadya.getGroup(op.param1)
                            nadya.sendMessageWithMention(op.param1, ra.creator.mid,"hallo","\nsalken group creator...")
            if msg.toType == 0:
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    nadya.sendContact(to, "u3b4d3e582a005f8efa2ad5b847aa204c")
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u3b4d3e582a005f8efa2ad5b847aa204c"
